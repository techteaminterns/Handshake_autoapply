...
/**
 * Formats the standard Telegram yes/no prompt for a discovered Handshake job.
 *
 * @param {object} job
...
export async function resolvePendingConfirmation(profileId, jobId, decision, options = {}) {
  ...
  if (error) {
    console.error('[telegram/jobConfirmation] resolve_job_confirmation RPC error:', error.message);
